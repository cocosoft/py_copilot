    ...
    return (
      <div className="skill-market skill-market--loading">
        <div className="skill-market__loading">
          ...
          <p>{t('settings.skillMarket.loading')}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="skill-market skill-market--error">
        <div className="skill-market__error">
          <h3>{t('settings.skillMarket.error.title')}</h3>
          <p>{error.message}</p>
          <button
            className="skill-market__retry-button"
            onClick={refreshSkills}
          >
            {t('settings.skillMarket.error.retry')}
          </button>
        </div>
      </div>
    );
    ...
    <div className="skill-market">
      ...
      <div className="skill-market__header">
        <div className="skill-market__header-content">
          <h1 className="skill-market__title">{t('settings.skillMarket.title')}</h1>
          <p className="skill-market__subtitle">
            {t('settings.skillMarket.subtitle')}
          </p>
        </div>
        ...
        <div className="skill-market__header-actions">
          <button
            ...
            disabled={isLoading}
          >
            {isLoading ? t('settings.skillMarket.buttons.refreshing') : t('settings.skillMarket.buttons.refresh')}
          </button>
          ...
          <div className="skill-market__view-controls">
            <button
              ...
              title={t('settings.skillMarket.buttons.gridView')}
            >
            ...
            <button
              ...
              title={t('settings.skillMarket.buttons.listView')}
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
      ...
      <div className="skill-market__controls">
        <SkillSearch
          ...
          placeholder={t('settings.skillMarket.search.placeholder')}
        />
        ...
        <div className="skill-market__main">
          {filteredSkills.length === 0 ? (
            <div className="skill-market__empty">
              ...
              <h3>{t('settings.skillMarket.empty.title')}</h3>
              <p>{t('settings.skillMarket.empty.description')}</p>
              <button
              ...
              >
                {t('settings.skillMarket.buttons.resetFilters')}
              </button>
            </div>
          ) : (
            <>
              ...
              {totalPages > 1 && (
                <div className="skill-market__pagination">
                  ...
                  >
                    {t('settings.skillMarket.buttons.previous')}
                  </button>
                  ...
                  >
                    {t('settings.skillMarket.buttons.next')}
                  </button>
                </div>
              )}
            </>
      ...
      <div className="skill-market__stats">
        <div className="skill-market__stats-item">
          <span className="skill-market__stats-label">{t('settings.skillMarket.stats.total')}</span>
          <span className="skill-market__stats-value">{skills.length}</span>
        </div>
        <div className="skill-market__stats-item">
          <span className="skill-market__stats-label">{t('settings.skillMarket.stats.installed')}</span>
          <span className="skill-market__stats-value">
            {skills.filter(s => s.installed).length}
          </span>
        </div>
        <div className="skill-market__stats-item">
          <span className="skill-market__stats-label">{t('settings.skillMarket.stats.matched')}</span>
